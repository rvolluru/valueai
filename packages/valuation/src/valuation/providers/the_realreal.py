...
class TheRealRealProvider(CompsProvider):
    name = "the_realreal"
    ...
    def fetch_comps(self, request: ValuationRequest) -> list[MarketComp]:
        ...
        try:
            html = fetch_page("https://www.therealreal.com/search", params=params)
        ...
        if not comps and firecrawl_enabled():
            ...
            for obj in nodes:
                ...
                out.append(
                    MarketComp(
                        ...
                        is_sold=False,
                        url=best_url(obj, "https://www.therealreal.com"),
                    )
                )
